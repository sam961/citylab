...
@section('content')
    ...
    <section class="home-slider owl-carousel">
        ...
        <div class="slider-item" style="background-image: url('citylab/img/slider-1.jpg');">
            <div class="container">
                <div class="row slider-text align-items-center">
                    <div class="col-md-7 col-sm-12 element-animate">
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 element-animate">
                <div class="col-md-8 text-center mb-5">
                    ...
                    <p class="mb-0 lead">CITY is a full service clinical laboratory with an inherently flexible approach and focus on quality to keep our clients satisfied with lab services. Our process are developed on customer centric approach and is driven by a single thrust, to provide the best standards of patient care .
                    </p>
                </div>
            </div>
            {{--<div class="row align-items-center">--}}
                ...
                {{--<div class="col-md-6 stretch-left-1 element-animate" data-animate-effect="fadeInLeft">--}}
                    {{--<a href="#" class="video"><img src="citylab/img/img_1.jpg" alt="" class="img-fluid"></a>--}}
                {{--</div>--}}
    ...
    <section class="section bg-light">
        <div class="container">
            <div class="row justify-content-center mb-5 element-animate">
                <div class="col-md-8 text-center mb-5">
                    <h2 class="text-uppercase heading border-bottom mb-4">Insurance</h2>
                ...
                <div class="major-caousel js-carousel-1 owl-carousel">
                    <div>
                        <div class="media d-block media-custom text-center">
                            <img src="citylab/img/insurance/arope.png" alt="Image Placeholder" class="img-fluid">
                            <div class="media-body">
                    ...
                    <div>
                        <div class="media d-block media-custom text-center">
                            <img src="citylab/img/insurance/fidelty.png" alt="Image Placeholder" class="img-fluid">
                            <div class="media-body">
                    ...
                    <div>
                        <div class="media d-block media-custom text-center">
                            <img src="citylab/img/insurance/bankers.png" alt="Image Placeholder" class="img-fluid">
                            <div class="media-body">
